    ...
    <div className="login">
      <img src={image} alt="stress-tracker" />
        <div className="logintext">
          ...
          <button style={{ backgroundColor: 'red', marginTop: '60px', width: '400px'}}>Sign Up in Google</button>
          <button style={{ backgroundColor: 'red',  width: '400px'}}>Sign Up with Facebook</button>
          </div>
